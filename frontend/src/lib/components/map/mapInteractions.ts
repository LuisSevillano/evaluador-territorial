...
const buildCellAsMunicipio = (props: any, sourceMunicipios: Municipio[]): Municipio | null => {
	...
	return {
		...
		precip_summer_mm: props.precip_summer ?? props.precip_summer_mm,
		precip_winter_mm: props.precip_winter ?? props.precip_winter_mm,
		precip_seasonality_index: props.precip_seasonality_index,
		aridity_index: props.aridity_index,
		summer_aridity_index: props.summer_aridity_index,
		dry_months_count: props.dry_months_count,
		moisture_absolute_score: props.moisture_absolute_score,
		summer_drought_score: props.summer_drought_score,
		precip_relative_score: props.precip_relative_score,
		precip_moisture_score: props.precip_moisture_score,
		water_drops_level: props.water_drops_level,
		water_drops_label: props.water_drops_label,
		...
		dist_renfe_madrid_km: undefined,
